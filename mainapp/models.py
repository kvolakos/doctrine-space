...
class Certcerts(models.Model):
    certid = models.IntegerField(db_column='certID')  # Field name made lowercase.
...
class Chrancestries(models.Model):
    ancestryid = models.IntegerField(db_column='ancestryID')  # Field name made lowercase.
...
class Chrbloodlines(models.Model):
    bloodlineid = models.IntegerField(db_column='bloodlineID')  # Field name made lowercase.
...
class Dgmexpressions(models.Model):
    expressionid = models.IntegerField(db_column='expressionID')  # Field name made lowercase.
...
class Evegraphics(models.Model):
    graphicid = models.IntegerField(db_column='graphicID')  # Field name made lowercase.
...
class Eveicons(models.Model):
    iconid = models.IntegerField(db_column='iconID')  # Field name made lowercase.
...
class Invmarketgroups(models.Model):
    marketgroupid = models.IntegerField(db_column='marketGroupID')  # Field name made lowercase.
...
class Invmetagroups(models.Model):
    metagroupid = models.IntegerField(db_column='metaGroupID')  # Field name made lowercase.
...
class Invtraits(models.Model):
    traitid = models.IntegerField(db_column='traitID')  # Field name made lowercase.
    typeid = models.IntegerField(db_column='typeID', blank=True, null=True)  # Field name made lowercase.
    skillid = models.IntegerField(db_column='skillID', blank=True, null=True)  # Field name made lowercase.
...
class Mapcelestialstatistics(models.Model):
    celestialid = models.IntegerField(db_column='celestialID')  # Field name made lowercase.
...
class Mapconstellations(models.Model):
    ...
    constellationid = models.IntegerField(db_column='constellationID')  # Field name made lowercase.
...
class Mapjumps(models.Model):
    stargateid = models.IntegerField(db_column='stargateID')  # Field name made lowercase.
...
class Maplandmarks(models.Model):
    landmarkid = models.IntegerField(db_column='landmarkID')  # Field name made lowercase.
...
class Mapsolarsystems(models.Model):
    regionid = models.IntegerField(db_column='regionID', blank=True, null=True)  # Field name made lowercase.
    constellationid = models.IntegerField(db_column='constellationID', blank=True, null=True)  # Field name made lowercase.
    solarsystemid = models.IntegerField(db_column='solarSystemID')  # Field name made lowercase.
...
class Mapuniverse(models.Model):
    universeid = models.IntegerField(db_column='universeID')  # Field name made lowercase.
...
class Skinlicense(models.Model):
    licensetypeid = models.IntegerField(db_column='licenseTypeID')  # Field name made lowercase.
...
class Skinmaterials(models.Model):
    skinmaterialid = models.IntegerField(db_column='skinMaterialID')  # Field name made lowercase.
...
class Skins(models.Model):
    skinid = models.IntegerField(db_column='skinID')  # Field name made lowercase.
...
class Stastationtypes(models.Model):
    stationtypeid = models.IntegerField(db_column='stationTypeID')  # Field name made lowercase.
...
class Trntranslationlanguages(models.Model):
    numericlanguageid = models.IntegerField(db_column='numericLanguageID')  # Field name made lowercase.
...
class Warcombatzones(models.Model):
    combatzoneid = models.IntegerField(db_column='combatZoneID')  # Field name made lowercase.
