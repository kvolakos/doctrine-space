"""
Django settings for doctrines project.
...
SECRET_KEY = '%7p0i@58h-6x8$j#+f99&*1(a^)53$1p62h7byc2i!3pbd=i53'
...
WSGI_APPLICATION = 'doctrines.wsgi.application'
